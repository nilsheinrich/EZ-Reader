...
class Dream():
    ...
    stochastic_loglike : evaluates likelihood for proposal AND current chain position every time if the likelihood has ingrained stochasticity; 
        roughly doubles the computational costs; DONT use this with multitry unless you know what you are doing
    """
    ...
    def __init__(self, model, variables=None, nseedchains=None, nCR=3, adapt_crossover=True, adapt_gamma=False,
                 ...
                 model_name=False, hardboundaries=True, mp_context=None, stochastic_loglike=False, **kwargs):
